  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Siswa Kelas X RPL A</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                        ...
                        <table id="table1" class="table table-sm table-hover dataTable-table">
                          <thead>
                            <tr class="bg-dark">
                              ...
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Nama</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Kelas</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">NISN</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Jenis Kelamin</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Tanggal Lahir</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Agama</a></th>
                          ...
                          <tbody>
                            ...
                            $sql = "SELECT * FROM siswa WHERE kelas = 'X RPL A'";
