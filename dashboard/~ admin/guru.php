          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="tambah-guru.php" class="btn btn-sm float-left btn-primary btn-icon-split">
                        ...
                        <table id="table1" class="table table-sm table-hover dataTable-table">
                          <thead>
                            <tr class="bg-dark">
                              ...
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">NIP</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">NUPTK</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Tanggal Lahir</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Telepon</a></th>
