                        ...
                        <table id="table1" class="table table-sm table-hover dataTable-table">
                          <thead>
                            <tr class="bg-dark">
                              ...
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Username</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Access</a></th>
