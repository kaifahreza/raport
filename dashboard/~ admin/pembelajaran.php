          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="tambah-admin.php" class="btn btn-sm float-left btn-primary btn-icon-split">
                        ...
                        <table id="table1" class="table table-sm table-hover dataTable-table">
                          <thead style="text-align: center;">
                            <tr class="bg-dark">
                              ...
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Mata Pelajaran</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Guru Mapel</a></th>
                              <th scope="col" data-sortable  class="asc"><a style="color: white;" href="#" class="dataTable-sorter">Nilai KKM</a></th>
